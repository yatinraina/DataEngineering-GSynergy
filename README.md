...
**How to Test :**
1. Import the 'PL_Total_Sales.zip' file into synapse.
3. Edit the notebook and write the location for the files where you have uploaded the data.
4. In the last cell change the path the staging folder and for writing the data please mention the sql pool name.
